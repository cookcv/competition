...
# train data
data_path = 'data/guangdong_round1_train2_20180910'
img_path, label = [], []
...
label_file.to_csv('data/label.csv', index=False,encoding='utf-8')

# test data
test_data_path = 'data/guangdong_round1_test_a_20180910'
...
test_file.to_csv('data/test.csv', index=False,encoding='utf-8')
